                ...
                <template v-for="proto of Object.keys(rows)">
                    <tr v-if="rows[proto].component">
                        ...
                        <td class="form-input" colspan="2">
                            <el-input type="textarea" v-model="form.content" id="proto"></el-input>
                    ...
                    <tr v-else-if="!rows[proto].rules && !rows[proto].options">
                        ...
                        <td class="form-input" colspan="2">
                            <el-input v-model="form[proto]" :id="proto"></el-input>
                        </td>
                    </tr>
                    ...
                    <tr v-if="rows[proto].options">
                        ...
                        <td class="form-input" colspan="2">
                            <el-select v-model="form[proto]" :placeholder="rows[proto].placeholder">
                                <el-option 
            ...
            */
            validateBeforeSubmit (
                ...
                if(this.verrors.any()) {
                    ...
                    if(this.edit) {
                        axios.put(this.$adminUrl(url) + '/' + this.form.id, this.form)
                        .then((responce) => {
                            if(responce.data) {
                                afterEditFn()
                                this.$message({
                        ...
                        axios.post(this.$adminUrl(url), this.form)
                        .then((responce) => {
                            if(responce.data) {
                                afterAddFn()
                                this.$message({
